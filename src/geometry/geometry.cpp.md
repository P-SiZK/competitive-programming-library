...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"src/geometry/geometry.cpp\"\n#include <algorithm>\n#include\
    \ <cmath>\n#include <iostream>\n#include <set>\n#include <vector>\n\nusing namespace\
  ...
  code: "#include <algorithm>\n#include <cmath>\n#include <iostream>\n#include <set>\n\
    #include <vector>\n\nusing namespace std;\n\nconst double EPS = 1e-10;\nconst\
    \ double PI = acos(-1);\n\nbool equals(double a, double b) { return fabs(a - b)\
    ...
    \ cross(Vector a, Vector b) { return a.x * b.y - a.y * b.x; }\n\nbool isParallel(Vector\
    \ a, Vector b) { return equals(cross(a, b), 0.0); }\n\nbool isOrthogonal(Vector\
...
documentation_of: src/geometry/geometry.cpp
layout: document
redirect_from:
- /library/src/geometry/geometry.cpp
- /library/src/geometry/geometry.cpp.html
