...
data:
  ...
  bundledCode: "#line 1 \"test/flow/ford_fulkerson/aoj_grl_6_a.test.cpp\"\n// verification-helper:\
    ...
    \ == 0) break;\n\t\t\tflow += f;\n\t\t}\n\t\treturn flow;\n\t}\n};\n\n\n#line\
    \ 4 \"test/flow/ford_fulkerson/aoj_grl_6_a.test.cpp\"\n\n#include <iostream>\n\
    \nusing namespace std;\n\nint main() {\n\tint v_sz, e_sz;\n\tcin >> v_sz >> e_sz;\n\
...
layout: document
redirect_from:
- /verify/test/flow/ford_fulkerson/aoj_grl_6_a.test.cpp
- /verify/test/flow/ford_fulkerson/aoj_grl_6_a.test.cpp.html
