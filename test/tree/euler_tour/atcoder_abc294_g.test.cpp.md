...
data:
  ...
  bundledCode: "#line 1 \"test/tree/euler_tour/atcoder_abc294_g.test.cpp\"\n// verification-helper:\
    ...
    \npublic:\n\tEulerTour(int n) : down(n), up(n), depth(n << 1), st(min, {1 << 30,\
...
layout: document
redirect_from:
- /verify/test/tree/euler_tour/atcoder_abc294_g.test.cpp
- /verify/test/tree/euler_tour/atcoder_abc294_g.test.cpp.html
