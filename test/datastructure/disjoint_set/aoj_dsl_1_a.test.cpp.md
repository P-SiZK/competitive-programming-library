...
data:
  ...
  bundledCode: "#line 1 \"test/datastructure/disjoint_set/aoj_dsl_1_a.test.cpp\"\n\
    ...
    \ num; }\n};\n\n\n#line 4 \"test/datastructure/disjoint_set/aoj_dsl_1_a.test.cpp\"\
    \n\n#include <iostream>\n\nusing namespace std;\n\nint main() {\n\tint n, q;\n\
    \tcin >> n >> q;\n\tDisjointSet ds(n);\n\tfor (int i = 0; i < q; ++i) {\n\t\t\
    int t, a, b;\n\t\tcin >> t >> a >> b;\n\t\tif (t == 0) ds.unite(a, b);\n\t\telse\
  ...
  verifiedWith: []
documentation_of: test/datastructure/disjoint_set/aoj_dsl_1_a.test.cpp
layout: document
redirect_from:
- /verify/test/datastructure/disjoint_set/aoj_dsl_1_a.test.cpp
- /verify/test/datastructure/disjoint_set/aoj_dsl_1_a.test.cpp.html
