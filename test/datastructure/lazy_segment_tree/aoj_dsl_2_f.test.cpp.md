...
data:
  ...
  bundledCode: "#line 1 \"test/datastructure/lazy_segment_tree/aoj_dsl_2_f.test.cpp\"\
    ...
    \ = n_ - 1; i > 0; --i) tree[i] = f(tree[2 * i], tree[2 * i + 1]);\n\t}\n\n\t\
    ...
    \ - 1);\n\t\tint l = s, r = t;\n\t\tT ll = ti, rr = ti;\n\t\twhile (l < r) {\n\
    \t\t\tif (l & 1) ll = f(ll, reflect(l++));\n\t\t\tif (r & 1) rr = f(reflect(--r),\
    \ rr);\n\t\t\tl >>= 1, r >>= 1;\n\t\t}\n\t\treturn f(ll, rr);\n\t}\n\n\tT at(int\
    \ i) {\n\t\ti += n_;\n\t\tthrust(i);\n\t\treturn reflect(i);\n\t}\n};\n\n\n#line\
    \ 4 \"test/datastructure/lazy_segment_tree/aoj_dsl_2_f.test.cpp\"\n\n#include\
    \ <algorithm>\n#include <iostream>\n#include <limits>\n\nusing namespace std;\n\
    \nint main() {\n\tint n, q;\n\tcin >> n >> q;\n\tauto f = [](int a, int b) { return\
    \ min(a, b); };\n\tauto g = [](int, int b) { return b; };\n\tauto h = [](int,\
    \ int b) { return b; };\n\tLazySegmentTree seg(f, g, h, numeric_limits<int>::max(),\
    \ -1);\n\tseg.init(n);\n\twhile (q--) {\n\t\tint com, s, t;\n\t\tcin >> com >>\
  ...
  requiredBy: []
  timestamp: '2024-01-06 12:34:09+09:00'
