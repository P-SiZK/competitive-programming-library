...
data:
  ...
  bundledCode: "#line 1 \"test/datastructure/lazy_segment_tree/dsl_2_f.test.cpp\"\n\
    ...
    \t\t\tl >>= 1, r >>= 1;\n\t\t}\n\t\treturn f(ll, rr);\n\t}\n\n\tT at(int i) {\
    \ return find(i, i + 1); }\n};\n\n\n#line 4 \"test/datastructure/lazy_segment_tree/dsl_2_f.test.cpp\"\
    \n\n#include <iostream>\n#include <limits>\n\nusing namespace std;\n\nint main()\
...
layout: document
redirect_from:
- /verify/test/datastructure/lazy_segment_tree/dsl_2_f.test.cpp
- /verify/test/datastructure/lazy_segment_tree/dsl_2_f.test.cpp.html
