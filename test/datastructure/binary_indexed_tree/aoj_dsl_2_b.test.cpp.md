...
data:
  ...
  bundledCode: "#line 1 \"test/datastructure/binary_indexed_tree/aoj_dsl_2_b.test.cpp\"\
    ...
    };\n\n\n#line 4 \"test/datastructure/binary_indexed_tree/aoj_dsl_2_b.test.cpp\"\
    \n\n#include <iostream>\n\nusing namespace std;\n\nint main() {\n\tint n, q;\n\
  ...
  verifiedWith: []
documentation_of: test/datastructure/binary_indexed_tree/aoj_dsl_2_b.test.cpp
layout: document
redirect_from:
- /verify/test/datastructure/binary_indexed_tree/aoj_dsl_2_b.test.cpp
- /verify/test/datastructure/binary_indexed_tree/aoj_dsl_2_b.test.cpp.html
