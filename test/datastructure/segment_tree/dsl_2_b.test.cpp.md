...
data:
  ...
  bundledCode: "#line 1 \"test/datastructure/segment_tree/dsl_2_b.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_B\n\n\
    ...
    \ + n_]; }\n};\n\n\n#line 4 \"test/datastructure/segment_tree/dsl_2_b.test.cpp\"\
    \n\n#include <iostream>\n\nusing namespace std;\n\nint main() {\n\tint n, q;\n\
    \tcin >> n >> q;\n\tSegmentTree seg([](long long a, long long b) { return a +\
    \ b; }, 0LL);\n\tseg.init(n);\n\twhile (q--) {\n\t\tint com, x, y;\n\t\tcin >>\
  ...
  code: "// verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_B\n\
    ...
    \ namespace std;\n\nint main() {\n\tint n, q;\n\tcin >> n >> q;\n\tSegmentTree\
    \ seg([](long long a, long long b) { return a + b; }, 0LL);\n\tseg.init(n);\n\t\
    while (q--) {\n\t\tint com, x, y;\n\t\tcin >> com >> x >> y;\n\t\t--x;\n\t\tif\
    \ (com) --y, cout << seg.find(x, y + 1) << endl;\n\t\telse seg.update(x, seg.at(x)\
    \ + y);\n\t}\n\n\treturn 0;\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/datastructure/segment_tree/dsl_2_b.test.cpp
layout: document
redirect_from:
- /verify/test/datastructure/segment_tree/dsl_2_b.test.cpp
- /verify/test/datastructure/segment_tree/dsl_2_b.test.cpp.html
