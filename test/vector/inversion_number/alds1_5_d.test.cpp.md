...
data:
  ...
  bundledCode: "#line 1 \"test/vector/inversion_number/alds1_5_d.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/lesson/1/ALDS1/5/ALDS1_5_D\n\
    ...
    \t\tres += i - bit.sum(idx);\n\t\tbit.add(idx, 1);\n\t}\n\treturn res;\n}\n\n\n\
    #line 4 \"test/vector/inversion_number/alds1_5_d.test.cpp\"\n\n#line 7 \"test/vector/inversion_number/alds1_5_d.test.cpp\"\
    \n\nusing namespace std;\n\nint main() {\n\tint n;\n\tcin >> n;\n\tvector<int>\
  ...
  verifiedWith: []
documentation_of: test/vector/inversion_number/alds1_5_d.test.cpp
layout: document
redirect_from:
- /verify/test/vector/inversion_number/alds1_5_d.test.cpp
- /verify/test/vector/inversion_number/alds1_5_d.test.cpp.html
