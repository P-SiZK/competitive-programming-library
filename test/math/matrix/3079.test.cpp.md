...
data:
  ...
  bundledCode: "#line 1 \"test/math/matrix/3079.test.cpp\"\n// verification-helper:\
    ...
    \ (int i = 0; i < k; ++i) {\n\t\t\tnum *= ModInt(n - i);\n\t\t\tden *= ModInt(i\
    \ + 1);\n\t\t}\n\t\treturn num / den;\n\t}\n};\n\n\n#line 5 \"test/math/matrix/3079.test.cpp\"\
    \n\n#line 7 \"test/math/matrix/3079.test.cpp\"\n\nusing namespace std;\n\nint\
  ...
  verifiedWith: []
documentation_of: test/math/matrix/3079.test.cpp
layout: document
redirect_from:
- /verify/test/math/matrix/3079.test.cpp
- /verify/test/math/matrix/3079.test.cpp.html
