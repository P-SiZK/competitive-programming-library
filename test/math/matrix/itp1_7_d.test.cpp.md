...
data:
  ...
  bundledCode: "#line 1 \"test/math/matrix/itp1_7_d.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/lesson/2/ITP1/7/ITP1_7_D\n\n\
    ...
    \t\twhile (n > 0) {\n\t\t\tif (n & 1) res *= tmp;\n\t\t\ttmp *= tmp;\n\t\t\tn\
    \ >>= 1;\n\t\t}\n\t\treturn res;\n\t}\n};\n\n\n#line 4 \"test/math/matrix/itp1_7_d.test.cpp\"\
    \n\n#include <iostream>\n\nusing namespace std;\n\nint main() {\n\tint n, m, l;\n\
    ...
    \t\t\tif (j) cout << \" \";\n\t\t\tcout << c[i][j];\n\t\t}\n\t\tcout << endl;\n\
    \t}\n\n\treturn 0;\n}\n"
  code: "// verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/lesson/2/ITP1/7/ITP1_7_D\n\
  ...
  verifiedWith: []
documentation_of: test/math/matrix/itp1_7_d.test.cpp
layout: document
redirect_from:
- /verify/test/math/matrix/itp1_7_d.test.cpp
- /verify/test/math/matrix/itp1_7_d.test.cpp.html
