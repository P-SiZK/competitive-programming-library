...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/cgl_1_b.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_1_B\n//\
    ...
    \t\t\tcnt += distance(b, e);\n\t\t}\n\t}\n\treturn cnt;\n}\n#line 5 \"test/geometry/geometry/cgl_1_b.test.cpp\"\
    \n\n#include <iomanip>\n#line 8 \"test/geometry/geometry/cgl_1_b.test.cpp\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/cgl_1_b.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/cgl_1_b.test.cpp
- /verify/test/geometry/geometry/cgl_1_b.test.cpp.html
