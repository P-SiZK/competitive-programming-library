...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/cgl_4_b.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/4/CGL_4_B\n//\
    ...
    \t\t\tcnt += distance(b, e);\n\t\t}\n\t}\n\treturn cnt;\n}\n#line 5 \"test/geometry/geometry/cgl_4_b.test.cpp\"\
    \n\n#include <iomanip>\n#line 8 \"test/geometry/geometry/cgl_4_b.test.cpp\"\n\n\
    int main() {\n\tcout << fixed << setprecision(10);\n\tint n;\n\tcin >> n;\n\t\
    Polygon p(n);\n\tfor (auto &a : p) cin >> a;\n\tcout << convex_diameter(p) <<\
    \ endl;\n\n\treturn 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/cgl_4_b.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/cgl_4_b.test.cpp
- /verify/test/geometry/geometry/cgl_4_b.test.cpp.html
