...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/aoj_cgl_3_c.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/3/CGL_3_C\n\n\
    ...
    test/geometry/geometry/aoj_cgl_3_c.test.cpp\"\n\n#line 6 \"test/geometry/geometry/aoj_cgl_3_c.test.cpp\"\
    \n\nusing namespace std;\n\nint main() {\n\tint n;\n\tcin >> n;\n\tPolygon g(n);\n\
    \tfor (auto &a : g) cin >> a;\n\tint q;\n\tcin >> q;\n\twhile (q--) {\n\t\tPoint\
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/aoj_cgl_3_c.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/aoj_cgl_3_c.test.cpp
- /verify/test/geometry/geometry/aoj_cgl_3_c.test.cpp.html
