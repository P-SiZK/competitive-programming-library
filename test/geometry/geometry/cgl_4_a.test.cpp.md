...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/cgl_4_a.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/4/CGL_4_A\n\n\
    ...
    \t\t\tcnt += distance(b, e);\n\t\t}\n\t}\n\treturn cnt;\n}\n#line 4 \"test/geometry/geometry/cgl_4_a.test.cpp\"\
    \n\n#line 6 \"test/geometry/geometry/cgl_4_a.test.cpp\"\n\nint main() {\n\tint\
    \ n;\n\tcin >> n;\n\tPolygon p(n);\n\tfor (auto &a : p) cin >> a;\n\tPolygon t\
    \ = convexHull(p);\n\tcout << t.size() << endl;\n\tfor (auto a : t) cout << a.x\
    \ << \" \" << a.y << endl;\n\n\treturn 0;\n}\n"
  code: "// verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/4/CGL_4_A\n\
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/cgl_4_a.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/cgl_4_a.test.cpp
- /verify/test/geometry/geometry/cgl_4_a.test.cpp.html
