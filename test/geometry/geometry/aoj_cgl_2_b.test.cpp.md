...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/aoj_cgl_2_b.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/2/CGL_2_B\n\n\
    ...
    test/geometry/geometry/aoj_cgl_2_b.test.cpp\"\n\n#line 6 \"test/geometry/geometry/aoj_cgl_2_b.test.cpp\"\
    \n\nusing namespace std;\n\nint main() {\n\tint q;\n\tcin >> q;\n\twhile (q--)\
    \ {\n\t\tSegment s1{}, s2{};\n\t\tcin >> s1 >> s2;\n\t\tcout << (intersect_ss(s1,\
    \ s2) ? 1 : 0) << endl;\n\t}\n\n\treturn 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/aoj_cgl_2_b.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/aoj_cgl_2_b.test.cpp
- /verify/test/geometry/geometry/aoj_cgl_2_b.test.cpp.html
