...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/aoj_cgl_2_a.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/2/CGL_2_A\n\n\
    ...
    test/geometry/geometry/aoj_cgl_2_a.test.cpp\"\n\n#line 6 \"test/geometry/geometry/aoj_cgl_2_a.test.cpp\"\
    \n\nusing namespace std;\n\nint main() {\n\tint q;\n\tcin >> q;\n\twhile (q--)\
    \ {\n\t\tVector p0{}, p1{}, p2{}, p3{};\n\t\tcin >> p0 >> p1 >> p2 >> p3;\n\t\t\
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/aoj_cgl_2_a.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/aoj_cgl_2_a.test.cpp
- /verify/test/geometry/geometry/aoj_cgl_2_a.test.cpp.html
