...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/aoj_cgl_3_b.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/3/CGL_3_B\n\n\
    ...
    test/geometry/geometry/aoj_cgl_3_b.test.cpp\"\n\n#line 6 \"test/geometry/geometry/aoj_cgl_3_b.test.cpp\"\
    \n\nusing namespace std;\n\nint main() {\n\tint n;\n\tcin >> n;\n\tPolygon p(n);\n\
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/aoj_cgl_3_b.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/aoj_cgl_3_b.test.cpp
- /verify/test/geometry/geometry/aoj_cgl_3_b.test.cpp.html
