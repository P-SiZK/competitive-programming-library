...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/cgl_3_b.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/3/CGL_3_B\n\n\
    ...
    \t\t\tcnt += distance(b, e);\n\t\t}\n\t}\n\treturn cnt;\n}\n#line 4 \"test/geometry/geometry/cgl_3_b.test.cpp\"\
    \n\n#line 6 \"test/geometry/geometry/cgl_3_b.test.cpp\"\n\nint main() {\n\tint\
    \ n;\n\tcin >> n;\n\tPolygon p(n);\n\tfor (auto &a : p) cin >> a;\n\tcout << (is_convex(p)\
    \ ? 1 : 0) << endl;\n\n\treturn 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/cgl_3_b.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/cgl_3_b.test.cpp
- /verify/test/geometry/geometry/cgl_3_b.test.cpp.html
