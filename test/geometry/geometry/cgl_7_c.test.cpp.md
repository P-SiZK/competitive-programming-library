...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/cgl_7_c.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_C\n//\
    ...
    \t\t\tcnt += distance(b, e);\n\t\t}\n\t}\n\treturn cnt;\n}\n#line 5 \"test/geometry/geometry/cgl_7_c.test.cpp\"\
    \n\n#include <iomanip>\n#line 8 \"test/geometry/geometry/cgl_7_c.test.cpp\"\n\n\
    int main() {\n\tcout << fixed << setprecision(10);\n\tPoint p1{}, p2{}, p3{};\n\
    \tcin >> p1 >> p2 >> p3;\n\tCircle c = get_circumscribed_circle(p1, p2, p3);\n\
    \tcout << c.c.x << \" \" << c.c.y << \" \" << c.r << endl;\n\n\treturn 0;\n}\n"
  code: "// verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_C\n\
    // verification-helper: ERROR 1e-6\n\n#include \"src/geometry/geometry.hpp\"\n\
    \n#include <iomanip>\n#include <iostream>\n\nint main() {\n\tcout << fixed <<\
    \ setprecision(10);\n\tPoint p1{}, p2{}, p3{};\n\tcin >> p1 >> p2 >> p3;\n\tCircle\
    \ c = get_circumscribed_circle(p1, p2, p3);\n\tcout << c.c.x << \" \" << c.c.y\
    \ << \" \" << c.r << endl;\n\n\treturn 0;\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/cgl_7_c.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/cgl_7_c.test.cpp
- /verify/test/geometry/geometry/cgl_7_c.test.cpp.html
