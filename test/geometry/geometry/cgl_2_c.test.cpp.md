...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/cgl_2_c.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/2/CGL_2_C\n//\
    ...
    \t\t\tcnt += distance(b, e);\n\t\t}\n\t}\n\treturn cnt;\n}\n#line 5 \"test/geometry/geometry/cgl_2_c.test.cpp\"\
    \n\n#include <iomanip>\n#line 8 \"test/geometry/geometry/cgl_2_c.test.cpp\"\n\n\
    int main() {\n\tcout << fixed << setprecision(10);\n\tint q;\n\tcin >> q;\n\t\
    while (q--) {\n\t\tSegment s1{}, s2{};\n\t\tcin >> s1 >> s2;\n\t\tPoint a = get_cross_point_ss(s1,\
    \ s2);\n\t\tcout << a.x << \" \" << a.y << endl;\n\t}\n\n\treturn 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/cgl_2_c.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/cgl_2_c.test.cpp
- /verify/test/geometry/geometry/cgl_2_c.test.cpp.html
