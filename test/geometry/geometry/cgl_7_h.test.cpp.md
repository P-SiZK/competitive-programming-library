...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/cgl_7_h.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_H\n//\
    ...
    \t\t\tcnt += distance(b, e);\n\t\t}\n\t}\n\treturn cnt;\n}\n#line 5 \"test/geometry/geometry/cgl_7_h.test.cpp\"\
    \n\n#include <iomanip>\n#line 8 \"test/geometry/geometry/cgl_7_h.test.cpp\"\n\n\
    int main() {\n\tcout << fixed << setprecision(10);\n\tint n;\n\tcin >> n;\n\t\
    Circle c{};\n\tc.c = Point(0, 0);\n\tcin >> c.r;\n\tPolygon p(n);\n\tfor (auto\
    \ &a : p) cin >> a;\n\tcout << area(p, c) << endl;\n\n\treturn 0;\n}\n"
  code: "// verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_H\n\
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/cgl_7_h.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/cgl_7_h.test.cpp
- /verify/test/geometry/geometry/cgl_7_h.test.cpp.html
