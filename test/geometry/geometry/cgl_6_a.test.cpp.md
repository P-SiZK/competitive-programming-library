...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry/cgl_6_a.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/6/CGL_6_A\n\n\
    ...
    \t\t\tcnt += distance(b, e);\n\t\t}\n\t}\n\treturn cnt;\n}\n#line 4 \"test/geometry/geometry/cgl_6_a.test.cpp\"\
    \n\n#line 7 \"test/geometry/geometry/cgl_6_a.test.cpp\"\n\nint main() {\n\tint\
    \ n;\n\tcin >> n;\n\tvector<Segment> ss(n);\n\tfor (auto &a : ss) cin >> a;\n\t\
  ...
  verifiedWith: []
documentation_of: test/geometry/geometry/cgl_6_a.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geometry/cgl_6_a.test.cpp
- /verify/test/geometry/geometry/cgl_6_a.test.cpp.html
