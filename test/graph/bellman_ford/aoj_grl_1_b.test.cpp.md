...
data:
  ...
  bundledCode: "#line 1 \"test/graph/bellman_ford/aoj_grl_1_b.test.cpp\"\n// verification-helper:\
    \ PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/1/GRL_1_B\n\n\
    ...
    \ 4 \"test/graph/bellman_ford/aoj_grl_1_b.test.cpp\"\n\n#include <iostream>\n\
    #line 7 \"test/graph/bellman_ford/aoj_grl_1_b.test.cpp\"\n\nusing namespace std;\n\
  ...
  code: "// verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/1/GRL_1_B\n\
    ...
    \tBellmanFord<int> bf(v);\n\tfor (int i = 0; i < e; ++i) {\n\t\tint s, t, d;\n\
    \t\tcin >> s >> t >> d;\n\t\tbf.add_edge(s, t, d);\n\t}\n\tbf.build(r);\n\tif\
    \ (bf.has_negative_cycle()) cout << \"NEGATIVE CYCLE\" << endl;\n\telse {\n\t\t\
    for (int i = 0; i < v; ++i) {\n\t\t\tif (bf.is_unreachable(i)) cout << \"INF\"\
  ...
  verifiedWith: []
documentation_of: test/graph/bellman_ford/aoj_grl_1_b.test.cpp
layout: document
redirect_from:
- /verify/test/graph/bellman_ford/aoj_grl_1_b.test.cpp
- /verify/test/graph/bellman_ford/aoj_grl_1_b.test.cpp.html
